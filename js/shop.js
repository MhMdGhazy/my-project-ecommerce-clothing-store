  const products = [
    ...
    {
      name: "Tshirt Silent Pain",
      price: 73.9,
      currency: "EG",
      gender: "Men", //
      image: "img/t shirts/Tshirt Silent Pain.png",
      type: "new",
      category: "tshirts",
    ...
    },
    {
      ...
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Tshirt D.png",
      type: "sale",
      category: "tshirts",
      availability: "inStock",
      size: ["XS", "S"],
    ...
    {
      name: "Tshirt Suicide Squad",
      price: 78.9,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Tshirt Suicide Squad.png",
      type: "sale",
      category: "tshirts",
      availability: "outOfStock",
      size: ["M", "L"],
    ...
    {
      name: "Tshirt Itachi Uchiha",
      price: 92.9,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Tshirt Itachi Uchiha.png",
      type: "new",
      category: "tshirts",
      availability: "inStock",
      size: ["XS", "S", "M"],
    ...
    {
      name: "Tshirt Rise Again",
      price: 92.9,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Tshirt Rise Again.png",
      type: "best",
      category: "tshirts",
      availability: "outOfStock",
      size: ["L", "XL"],
    },
    {
      ...
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Arabian Touch.png",
      type: "new",
      category: "tshirts",
      availability: "inStock",
      size: ["M"],
    ...
    },
    {
      ...
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Mens Polo Shirt.png",
      type: "best",
      category: "tshirts",
      availability: "inStock",
      size: ["XS", "M"],
    },
    {
      ...
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Jogger Shorts.png",
      type: "new",
      category: "shorts",
      availability: "inStock",
      size: ["M", "L"],
      colors: {
    "Black": "img/t shirts/Jogger Shorts.png",
    "White": "img/t shirts/Jogger Shorts.png",
    "Brown": "img/t shirts/Jogger Shorts.png"
  }
    },
    {
      name: "AC Hoodie BLACK",
      price: 133,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/hoodie-black.png",
      type: "sale",
      category: "hoodies",
      availability: "outOfStock",
      size: ["S", "M", "L"],
    ...
    {
      name: "New Hoodie White",
      price: 133,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/hoodie-white.png",
      type: "new",
      category: "hoodies",
      availability: "inStock",
      size: ["L", "XL"],
    },
    {
      ...
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/hoodie-red.png",
      type: "new",
      category: "hoodies",
      availability: "inStock",
      size: ["M", "L"],
    ...
    {
      name: "New Hoodie Turquoise",
      price: 133,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/hoodie-Turquoise.png",
      type: "new",
      category: "hoodies",
      availability: "outOfStock",
      size: ["M", "L", "XL"],
    ...
    {
      name: "Adidas Originals Pants White",
      price: 100,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/pants-White.png",
      type: "best",
      category: "pants",
      availability: "inStock",
      size: ["S", "M"],
    ...
    {
      name: "Adidas Originals Pants Blue",
      price: 100,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/pants-Blue.png",
      type: "sale",
      category: "pants",
      availability: "outOfStock",
      size: ["M"],
    ...
    {
      name: "Adidas Originals Pants Red",
      price: 100,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/pants-Red.png",
      type: "new",
      category: "pants",
      availability: "inStock",
      size: ["M", "L", "XL"],
    ...
    {
      name: "Adidas Originals Pants Purple",
      price: 100,
      currency: "EG",
          gender: "Men", //
    ...
    {
      name: "Adidas Originals Pants Turquoise",
      price: 100,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/pants-Turquoise.png",
      type: "best",
      category: "pants",
      availability: "inStock",
      size: ["XS", "M"],
    ...
    {
      name: "Jean Jackets For Men |Denim Jackets withTshirt",
      price: 450,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Jackets-Jean-Denim.png",
      type: "new",
      category: "hoodies",
      availability: "inStock",
      size: ["M", "L", "XL"],
    ...
    {
      name: "Jackets For Men |Black Jackets withTshirt",
      price: 400,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Black-Jackets-withTshirt.png",
      type: "sale",
    ...
    {
      name: "Yeezy Shoes | Adidas Yeezy Boost Neon",
      price: 1200,
      currency: "EG",
          gender: "Men", //
      image: "img/t shirts/Yeezy Boost.png",
      type: "sale",
  categories: ["hoodies", "Men"], 
      availability: "inStock",
      size: ["XS", "S", "M"],
  ...
  priceRangeInput.addEventListener("input", (event) => {
    ...
    priceMaxDisplay.innerText = `${maxPrice} EG`;
    filterProducts();
  });
